...
class HobbiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hobby" do
    assert_difference('Hobby.count') do
      post hobbies_url, params: { hobby: { name: @hobby.name, student_id: @hobby.student_id } }
    end
  ...
  test "should update hobby" do
    patch hobby_url(@hobby), params: { hobby: { name: @hobby.name, student_id: @hobby.student_id } }
